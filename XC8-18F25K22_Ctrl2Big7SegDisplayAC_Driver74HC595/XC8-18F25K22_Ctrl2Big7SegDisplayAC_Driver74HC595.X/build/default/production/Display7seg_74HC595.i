...
uint8_t NUMBERS_OF_DISPLAYS = 2;
# 47 "./Display7seg_74HC595.h"
uint8_t digits[]={
...
# 26 "./main.h" 2
# 13 "Display7seg_74HC595.c" 2
# 30 "Display7seg_74HC595.c"
void DISPLAY_Set(uint8_t D1, uint8_t D2){
...
# 54 "Display7seg_74HC595.c"
void DISPLAY_Reset(void){
    DISPLAY_Set(16, 16);
}
# 66 "Display7seg_74HC595.c"
void DISPLAY_Write(uint8_t num){
    uint8_t digit1=16;
    uint8_t digit2=16;
