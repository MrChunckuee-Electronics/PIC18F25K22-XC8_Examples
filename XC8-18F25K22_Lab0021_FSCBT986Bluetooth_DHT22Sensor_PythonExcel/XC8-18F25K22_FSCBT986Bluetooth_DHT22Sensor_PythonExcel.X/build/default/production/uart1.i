...
# 1 "./INTERRUPTManager.h" 1
# 88 "./INTERRUPTManager.h"
    _Bool TMR0_ovrFlag = 0;
...
static volatile char txBuffer[64];
...
void UART1_Initialize(long baudRate){
    ...
    if(baudRate >= 19200){
        ...
        brgValue = (uint16_t)((16000000 / (4 * baudRate)) - 1);
    }
        ...
        TXSTAbits.BRGH = 0;
        BAUDCON1bits.BRG16 = 1;
        brgValue = (uint16_t)((16000000 / (16 * baudRate)) - 1);
    }
    else{
        ...
        brgValue = (uint16_t)((16000000 / (64 * baudRate)) - 1);
    }
