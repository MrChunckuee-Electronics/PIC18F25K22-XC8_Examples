...
# 2 "<built-in>" 2
# 1 "LiquidCrystalDisplay.c" 2
# 48 "LiquidCrystalDisplay.c"
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\c99\\stdbool.h" 1 3
# 48 "LiquidCrystalDisplay.c" 2
...
_Bool LCD_Init(LCD_t display){
    ...
    *(LCDisplay.PORT) &= ~(1 << LCDisplay.RS);
    ...
    do { unsigned char cmd = 0x08; if ( 1 == 1 ) { cmd |= 1 << 2; } if ( 0 == 1 ) { cmd |= 1 << 1; } if ( 0 == 1 ) { cmd |= 1; } LCD_Command(cmd); } while (0);
