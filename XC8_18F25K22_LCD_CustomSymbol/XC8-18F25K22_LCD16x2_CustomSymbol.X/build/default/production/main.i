...
# 1 "./LiquidCrystalDisplay.h" 1
# 17 "./LiquidCrystalDisplay.h"
    typedef struct {
...
# 77 "./LiquidCrystalDisplay.h"
    _Bool LCD_Init(LCD_t display);
...
void main(void) {
    ...
    LCD_Command (0x01);;
    do { if ( 0 == 0 ) { LCD_Command(0x80 + 0); } else if ( 0 == 1 ) { LCD_Command(0xC0 + 0); } else if ( 0 == 2 ) { LCD_Command(0x94 + 0); } else if ( 0 == 3 ) { LCD_Command(0xD4 + 0); } } while(0);
    LCD_puts("MrChunckuee!!");

    do { if ( 1 == 0 ) { LCD_Command(0x80 + 0); } else if ( 1 == 1 ) { LCD_Command(0xC0 + 0); } else if ( 1 == 2 ) { LCD_Command(0x94 + 0); } else if ( 1 == 3 ) { LCD_Command(0xD4 + 0); } } while(0);
    LCD_putc(0);
    do { if ( 1 == 0 ) { LCD_Command(0x80 + 1); } else if ( 1 == 1 ) { LCD_Command(0xC0 + 1); } else if ( 1 == 2 ) { LCD_Command(0x94 + 1); } else if ( 1 == 3 ) { LCD_Command(0xD4 + 1); } } while(0);
    LCD_putc(1);


    do { if ( 1 == 0 ) { LCD_Command(0x80 + 4); } else if ( 1 == 1 ) { LCD_Command(0xC0 + 4); } else if ( 1 == 2 ) { LCD_Command(0x94 + 4); } else if ( 1 == 3 ) { LCD_Command(0xD4 + 4); } } while(0);
    LCD_putc(255);
    do { if ( 1 == 0 ) { LCD_Command(0x80 + 5); } else if ( 1 == 1 ) { LCD_Command(0xC0 + 5); } else if ( 1 == 2 ) { LCD_Command(0x94 + 5); } else if ( 1 == 3 ) { LCD_Command(0xD4 + 5); } } while(0);
    LCD_putc(252);
    do { if ( 1 == 0 ) { LCD_Command(0x80 + 6); } else if ( 1 == 1 ) { LCD_Command(0xC0 + 6); } else if ( 1 == 2 ) { LCD_Command(0x94 + 6); } else if ( 1 == 3 ) { LCD_Command(0xD4 + 6); } } while(0);
    LCD_putc(0b11110100);
    do { if ( 1 == 0 ) { LCD_Command(0x80 + 7); } else if ( 1 == 1 ) { LCD_Command(0xC0 + 7); } else if ( 1 == 2 ) { LCD_Command(0x94 + 7); } else if ( 1 == 3 ) { LCD_Command(0xD4 + 7); } } while(0);
    LCD_putc(0b11101110);
    do { if ( 1 == 0 ) { LCD_Command(0x80 + 8); } else if ( 1 == 1 ) { LCD_Command(0xC0 + 8); } else if ( 1 == 2 ) { LCD_Command(0x94 + 8); } else if ( 1 == 3 ) { LCD_Command(0xD4 + 8); } } while(0);
    LCD_putc(0b11110111);
