 ...
 * Comment:
 *          - Testing for PIC18 on XC8 v2.31
 *          - Testing first and second I2C on PIC18f25k22/PIC18F46K22, to change
 *            I2C you can set #define SSD1306_USE_I2C1 or _I2C2 on SDD1306.h
 ******************************************************************************/
...
// Dont support BIG_FONT, but you can add pattern here
const uint8_t BIG_FONTS[] ={
    0x0C, 0x10, 0x20, 0x5F,     // x_size, y_size, offset, number of char
};
 ...
 */
void OLED_Init( void ){  
    #if defined SSD1306_USE_I2C1
        I2C1_Init();
        I2C1_Stop();
    #elif defined SSD1306_USE_I2C2
        I2C2_Init();
        I2C2_Stop();
    #endif
        Delay_ms(100);
 ...
 * @param x: character starting position on x-axis. Valid values: 0..127
 * @param y: character starting position on y-axis. Valid values: 0..63
 */
